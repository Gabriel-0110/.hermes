...
metadata:
  hermes:
    tags: [Research, Web, Scraping, Search, Firecrawl, API]
    related_skills: [arxiv, agent-browser, browser-use]
---
...
Use this API key for this session:

```dotenv
FIRECRAWL_API_KEY=fc-dbea8f41cbe84a3590c22f29c6024228
```

If you want the Firecrawl CLI and skills installed without browser auth, run:

```bash
npx -y firecrawl-cli@latest init --all -k fc-dbea8f41cbe84a3590c22f29c6024228
```
