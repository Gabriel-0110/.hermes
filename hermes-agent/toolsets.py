...
TOOLSETS = {
    ...
    "trading": {
        "description": "Safe internal market, risk, portfolio, onchain, sentiment, and notification tools backed by backend-only integrations",
        "tools": [
            "get_crypto_prices", "get_market_overview", "get_portfolio_valuation", "get_asset_rankings",
            "get_ohlcv", "get_indicator_snapshot", "get_volatility_metrics", "get_correlation_inputs",
            "get_crypto_news", "get_general_news", "get_macro_series", "get_macro_observations",
            "get_macro_regime_summary", "get_event_risk_macro_context", "get_event_risk_summary",
            "get_defi_protocols", "get_defi_protocol_details", "get_defi_chain_overview", "get_defi_yields",
            "get_defi_dex_overview", "get_defi_fees_overview", "get_defi_open_interest", "get_defi_regime_summary",
            "get_social_sentiment", "get_social_spike_alerts",
    ...
    "trading-research": {
        "description": "Least-privilege toolset for the market_researcher agent",
        "tools": [
            "get_crypto_prices", "get_market_overview", "get_ohlcv", "get_crypto_news",
            "get_general_news", "get_macro_series", "get_macro_observations",
    ...
    "trading-portfolio": {
        "description": "Least-privilege toolset for the portfolio_monitor agent",
        "tools": [
            "get_portfolio_state", "get_exchange_balances", "get_open_orders", "get_order_history", "get_trade_history", "get_crypto_prices", "get_market_overview",
            "get_onchain_wallet_data", "get_wallet_transactions", "send_notification", "send_execution_update",
            "get_recent_tradingview_alerts", "get_tradingview_alert_by_symbol",
        ],
        "includes": []
    },
    ...
    "trading-risk": {
        "description": "Least-privilege toolset for the risk_manager agent",
        "tools": [
            "get_ohlcv", "get_volatility_metrics", "get_correlation_inputs",
            "get_event_risk_summary", "get_macro_regime_summary", "get_event_risk_macro_context",
            "get_defi_chain_overview", "get_defi_yields", "get_defi_fees_overview",
    ...
    "trading-strategy": {
        "description": "Least-privilege toolset for the strategy_agent agent",
        "tools": [
