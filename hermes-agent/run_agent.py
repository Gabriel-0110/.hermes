...
class AIAgent:
    ...
    def __init__(
        ...
        config_context_length_override: int | None = None,
        compression_threshold_override: float | None = None,
    ):
        """
        ...
        if compression_threshold_override is not None:
            try:
                compression_threshold = float(compression_threshold_override)
            except (TypeError, ValueError):
                logger.debug(
                    "Invalid compression_threshold_override=%r; using config value",
                    compression_threshold_override,
                )
        ...
        if config_context_length_override is not None:
            _config_context_length = config_context_length_override
