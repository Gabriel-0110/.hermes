...
def _profile_is_enabled_for_env(var_name: str) -> bool:
    """Return whether the active profile matches an optional env allowlist.

    The env var accepts a comma-separated list of Hermes profile names.
    When unset or empty, the feature remains enabled for all profiles.
    """
    ...
    return active_profile in allowed
...
def _apply_env_overrides(config: GatewayConfig) -> None:
    ...
    if slack_token and _profile_is_enabled_for_env("SLACK_ENABLED_PROFILES"):
