...
_TEMP_DIR_REAL = os.path.realpath(tempfile.gettempdir())
...
def _check_sensitive_path(filepath: str) -> str | None:
    ...
    # Always allow writes inside the OS temp directory (e.g. /private/var/folders on macOS)
    temp_prefix = _TEMP_DIR_REAL if _TEMP_DIR_REAL.endswith(os.sep) else _TEMP_DIR_REAL + os.sep
    if resolved.startswith(temp_prefix) or normalized.startswith(temp_prefix):
        return None
    _err = (
