...
SYNC_KEYS = [
    ...
    "AWS_BEARER_TOKEN_BEDROCK", "AWS_BEDROCK_BASE_URL", "AWS_BEDROCK_REGION",
    "AWS_BEDROCK_MODEL_ID_1", "AWS_BEDROCK_ARN_1",
    "AWS_BEDROCK_MODEL_ID_2", "AWS_BEDROCK_ARN_2",
    "AWS_BEDROCK_MODEL_ID_3", "AWS_BEDROCK_ARN_3",
    "AWS_BEDROCK_MODEL_ID_4",
    "AWS_BEDROCK_MODEL_ID_5", "AWS_BEDROCK_ARN_5",
]
